...
export async function getWaareeLiveTelemetry(
  ...
  // Try Waaree Generic API first (on digital.waaree.com)
...
/** @deprecated Use getWaareeLiveTelemetry(plantId, username, password, apiKey) */
export async function fetchWaareeFlowData(plantId: string, token?: string, secret?: string): Promise<any> {
  throw new Error(
    "[Waaree] fetchWaareeFlowData is deprecated. Use getWaareeLiveTelemetry with (plantId, username, password, apiKey)."
  );
}
