...
async function main() {
  try {
    console.log("Attempting to log in as swayogenergy@gmail.com...");
    const session = await login({
      identifier: "swayogenergy@gmail.com",
    ...
    console.log("Listing employees as ADMIN...");
    const employees = await listInternalUsers("ADMIN", { limit: 200, role: "EMPLOYEE" });
