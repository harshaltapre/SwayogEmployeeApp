 ...
 */
export async function getLatestAppUpdate(req: Request, res: Response, next: NextFunction): Promise<void> {
 ...
 */
export async function downloadLatestApk(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
